...
/**
 * This function adds all of the tests contained in aes_keywrap_test.c to a 
 ...
 *                    the pelz AES keywrap functionality tests to.
 *
 ...
 * kmyth's AEC Key Wrap (RFC-3394) functionality.
 *
