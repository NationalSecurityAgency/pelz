...
void test_table_initAddDestroy(void)
{
  ...
  CharBuf key;
  char cwd[1024];
  char *valid_id[3] = {"file:/test/key_files/key1.txt", "file:/test/key_files/key2.txt", "file:/test/key_files/key3.txt"};
  char *tmp_id;
  ...
  tmp_id = "file:/test/key_files/key7.txt";
...
void test_table_initLookupAddDestroy(void)
{
  ...
  CU_ASSERT(key_table_init(&key_table) == 0)
...
void test_table_initLookupAddDeleteDestroy(void)
{
  ...
  CharBuf tmp;
  char cwd[1024];
  char *valid_id[6] = { "file:/test/key_files/key1.txt", "file:/test/key_files/key2.txt", "file:/test/key_files/key3.txt",
			"file:/test/key_files/key4.txt", "file:/test/key_files/key5.txt", "file:/test/key_files/key6.txt" };
  char *tmp_id;
  ...
  tmp_id = "file:/test/key_files/key.txt";
  tmp = newCharBuf(strlen(tmp_id) + strlen(cwd));
  memcpy(tmp.chars, tmp_id, 5);
  memcpy(&tmp.chars[5], cwd, strlen(cwd));
  memcpy(&tmp.chars[5 + strlen(cwd)], &tmp_id[5], (tmp.len - strlen(cwd) - 5));
  ...
  freeCharBuf(&tmp);
  tmp_id = "file:/test/key_files/key1txt";
  tmp = newCharBuf(strlen(tmp_id) + strlen(cwd));
  memcpy(tmp.chars, tmp_id, 5);
  memcpy(&tmp.chars[5], cwd, strlen(cwd));
  memcpy(&tmp.chars[5 + strlen(cwd)], &tmp_id[5], (tmp.len - strlen(cwd) - 5));
