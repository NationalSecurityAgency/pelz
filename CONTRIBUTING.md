...
Pelz is an open source project. If you are interested in making it better,
...
Patches should be submitted in the form of Pull Requests to the Pelz
...
- Not all innovative ideas need to be accepted as pull requests into this GitHub project to be valuable to the community.        
  There may be times when we recommend that you just share your code for some enhancement to Pelz from your own repository. 
